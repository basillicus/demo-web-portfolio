			...
			{#each projects as project}
				<div class="card">
					<div class="p-6">
						...
						<a href="/projects/{project.slug}" class="text-primary hover:underline font-medium">View Project</a>
					</div>
				</div>
			{/each}
		</div>
			...
			{#each blogPosts as post}
				<div class="card">
					<div class="p-6">
						...
						<a href="/blog/{post.slug}" class="text-primary hover:underline font-medium">Read Article</a>
					</div>
				</div>
			{/each}
		</div>
